...
q2 : MMult1_solved.cpp
	g++-8 -fopenmp -o MMult1_solved MMult1_solved.cpp
...
#Clean executables
clean :
	rm val_test01_solved val_test02_solved MMult1_solved omp_solved2 omp_solved3 omp_solved4 omp_solved5 omp_solved6 jacobi2D-omp gs2D-omp