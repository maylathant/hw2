...
void print_results(float array[N], int tid, int section) 
{
  ...
  //#pragma omp critical //Anthony Maylath correction: not needed, outside of parellel scope
  {
  ...
  //#pragma omp barrier //Anthony Maylath Correction: other threads cannot reach
      //program hangs and two threads don't reach final barrier
